...
sudo scutil --set ComputerName "MBA_Juan"
sudo scutil --set HostName "mba-juan"
sudo scutil --set LocalHostName "mba-juan"
...
defaults write com.apple.Safari PreloadTopHit -int p
